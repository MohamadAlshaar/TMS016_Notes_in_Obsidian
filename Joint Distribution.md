Think of temperature on a surface, each points temperature change over time can be described using a distribution, now if we add the distributions of all these points we get a joint distribution. 
